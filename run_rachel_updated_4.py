...
Export Rachel B-Roll brief v2 (smart page breaks, closing UI, compact tables)
...
OUT_DIR = os.path.join(BASE_DIR, "output", "updated-4")
...
def main():
    ...
    print("Building updated-4 export...")
