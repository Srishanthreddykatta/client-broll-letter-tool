"""
Export Rachel B-Roll brief v2 to output/updated-7/ (Section C starts on new page).
"""
...
from brief_document import build_client_brief_html, build_production_brief
...
OUT_DIR = os.path.join(BASE_DIR, "output", "updated-7")
...
def main():
    ...
    v2_md, html = build_production_brief(raw_md, CLIENT_FULL_NAME, EPISODE_TITLE)
    ...
    print("Building updated-7 export...")
    subprocess.run(
        [
            sys.executable,
