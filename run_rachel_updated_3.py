"""
Export Rachel B-Roll brief v2 (compact tables, revised columns, page-2 layout)
to output/updated-3/.
"""
...
OUT_DIR = os.path.join(BASE_DIR, "output", "updated-3")
...
def main():
    ...
    print("Building updated-3 export...")
    subprocess.run(
        [
            sys.executable,
