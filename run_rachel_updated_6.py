...
Export Rachel B-Roll brief v2 to output/updated-6/ (Section B page logic, C+D together).
...
OUT_DIR = os.path.join(BASE_DIR, "output", "updated-6")
...
def main():
    ...
    print("Building updated-6 export...")
